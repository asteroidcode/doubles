  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        ...
        {amountOfRounds === 14 && <><Round num={1} round={round1}/><Round num={2} round={round2}/><Round num={3} round={round3}/><Round num={4} round={round4}/><Round num={5} round={round5}/><Round num={6} round={round6}/><Round num={7} round={round7}/><Round num={8} round={round8}/><Round num={9} round={round9}/><Round num={10} round={round10}/><Round num={11} round={round11}/><Round num={12} round={round12}/><Round num={13} round={round13}/><Round num={14} round={round14}/></>}
        {amountOfRounds === 15 && <><Round num={1} round={round1}/><Round num={2} round={round2}/><Round num={3} round={round3}/><Round num={4} round={round4}/><Round num={5} round={round5}/><Round num={6} round={round6}/><Round num={7} round={round7}/><Round num={8} round={round8}/><Round num={9} round={round9}/><Round num={10} round={round10}/><Round num={11} round={round11}/><Round num={12} round={round12}/><Round num={13} round={round13}/><Round num={14} round={round14}/><Round num={15} round={round15}/></>}
